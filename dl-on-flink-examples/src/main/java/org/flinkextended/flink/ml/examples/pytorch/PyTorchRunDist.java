...
/**
 * run PyTorch all reduce test main class. test machine learning framework PyTorch on flink stream
 * and table api.
 */
public class PyTorchRunDist {
    ...
    private void runTable(String script) throws Exception {
        Map<String, String> prop = createConfigProps();
        PyTorchConfig pytorchConfig = new PyTorchConfig(3, prop, script, "map_func", envPath);
        StreamExecutionEnvironment streamEnv = StreamExecutionEnvironment.getExecutionEnvironment();
