...
public final class StateMachineBuilder<
     ...
     * Constructor
     *
     * <p>This is the only constructor in the API.
     */
    ...
    private StateMachineBuilder(
            StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT> that, boolean optimized) {
        this.defaultInitialState = that.defaultInitialState;
    ...
    private class TransitionsListNode {
        ...
        TransitionsListNode(
                StateMachineBuilder.ApplicableTransition<OPERAND, STATE, EVENTTYPE, EVENT>
                        transition,
    ...
    private static class ApplicableSingleOrMultipleTransition<
                    OPERAND, STATE extends Enum<STATE>, EVENTTYPE extends Enum<EVENTTYPE>, EVENT>
        ...
        @Override
        public void apply(StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT> subject) {
            ...
            if (transitionMap == null) {
                ...
                transitionMap =
                        new HashMap<EVENTTYPE, Transition<OPERAND, STATE, EVENTTYPE, EVENT>>();
    ...
    public StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT> addTransition(
        ...
        return new StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT>(
                this,
                new StateMachineBuilder.ApplicableSingleOrMultipleTransition<
                        OPERAND, STATE, EVENTTYPE, EVENT>(
                        preState,
                        eventType,
                        new StateMachineBuilder.SingleInternalArc(postState, hook)));
    }
    ...
    public StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT> addTransition(
        ...
        return new StateMachineBuilder<OPERAND, STATE, EVENTTYPE, EVENT>(
                ...
                new StateMachineBuilder.ApplicableSingleOrMultipleTransition<
                        ...
                        preState,
                        eventType,
                        new StateMachineBuilder.MultipleInternalArc(postStates, hook)));
    }
    ...
    private void makeStateMachineTable() {
        ...
        Map<STATE, Map<EVENTTYPE, Transition<OPERAND, STATE, EVENTTYPE, EVENT>>> prototype =
    ...
    private class MultipleInternalArc
        ...
        MultipleInternalArc(
                Set<STATE> postStates, MultipleArcTransition<OPERAND, EVENT, STATE> hook) {
    ...
    private class InternalStateMachine implements StateMachine<STATE, EVENTTYPE, EVENT> {
        ...
        public synchronized STATE doTransition(EVENTTYPE eventType, EVENT event)
                throws InvalidStateTransitionException {
            currentState =
                    StateMachineBuilder.this.doTransition(operand, currentState, eventType, event);
            return currentState;
        }
    }
}
