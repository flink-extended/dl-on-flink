...
public class RoleUtils {
	...
	public static Table addRole(TableEnvironment tableEnv, ExecutionMode mode,
		...
		if (outputSchema == null) {
			if (worker != null) {
				tableEnv.registerTableSink("dummySink",new TableStreamDummySink());
				worker.insertInto("dummySink");
			}
		}
		return worker;
	}
	...
	public static void addAMRole(TableEnvironment tableEnv, MLConfig mlConfig) {
		...
		tableEnv.registerTableSink("tableDummySink",new TableStreamDummySink());
		am.insertInto("tableDummySink");
