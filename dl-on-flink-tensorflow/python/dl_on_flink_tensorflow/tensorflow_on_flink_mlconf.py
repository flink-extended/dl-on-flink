...
class MLCONSTANTS(object):
    ...
    PYTHON_PROCESS_LOGGER_CONSUMER_CLASS = str(ml_constants.PYTHON_PROCESS_LOGGER_CONSUMER_CLASS)
    ...
    STORAGE_LOCAL_FILE = str(ml_constants.STORAGE_LOCAL_FILE)
    CONFIG_STORAGE_LOCAL_FILE_ROOT = str(ml_constants.CONFIG_STORAGE_LOCAL_FILE_ROOT)
    ...
    PYTHON_EXEC = str(ml_constants.PYTHON_EXEC)
