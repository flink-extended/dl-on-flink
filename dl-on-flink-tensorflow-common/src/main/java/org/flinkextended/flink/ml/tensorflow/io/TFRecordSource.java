...
public class TFRecordSource extends InputFormatSourceFunction<byte[]>
    ...
    public static TFRecordSource createSource(
            String[] paths, int epochs, Configuration configuration) {
