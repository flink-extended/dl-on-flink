...
/** A pure-java implementation of the CRC32 checksum. */
public class Crc32C implements Checksum {
    private static final int MASK_DELTA = 0xa282ead8;
    private final PureJavaCrc32C crc32C;
     ...
     *
     * <p>Motivation: it is problematic to compute the CRC of a string that contains embedded CRCs.
