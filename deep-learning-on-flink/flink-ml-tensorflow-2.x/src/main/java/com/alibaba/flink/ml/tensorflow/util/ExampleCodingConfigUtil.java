...
public class ExampleCodingConfigUtil {
     ...
     */
    public static void configureEncodeExampleCoding(TFConfigBase config, String[] encodeNames, DataTypes[] encodeTypes,
     ...
     * @param entryClass java object class for each entry
     */
    public static void configureDecodeExampleCoding(TFConfigBase config, String[] decodeNames, DataTypes[] decodeTypes,
													ExampleCodingConfig.ObjectType entryType, Class entryClass) {
     ...
     * @param entryClass java object class for each entry
     */
    public static void configureEncodeExampleCoding(TFConfigBase config, String[] encodeNames, TypeInformation[] encodeTypes,
													ExampleCodingConfig.ObjectType entryType, Class entryClass) {
     ...
     * @param entryClass java object class for each entry
     */
    public static void configureDecodeExampleCoding(TFConfigBase config, String[] decodeNames, TypeInformation[] decodeTypes,
													ExampleCodingConfig.ObjectType entryType, Class entryClass) {
     ...
     * @param entryClass java object class for each entry
     */
    public static void configureExampleCoding(TFConfigBase config, TableSchema encodeSchema, TableSchema decodeSchema,
											  ExampleCodingConfig.ObjectType entryType, Class entryClass) {
