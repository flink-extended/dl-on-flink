...
public class TFConstants {
	...
	public static final String INPUT_TF_EXAMPLE_CONFIG = MLConstants.SYS_PREFIX + "input_tf_example_config";
	public static final String OUTPUT_TF_EXAMPLE_CONFIG = MLConstants.SYS_PREFIX + "output_tf_example_config";
