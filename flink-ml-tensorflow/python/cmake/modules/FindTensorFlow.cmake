...
if(TensorFlow_FOUND)
  ...
  execute_process(
    COMMAND ${PYTHON_EXECUTABLE} -c "import tensorflow as tf; print(tf.__version__); print(0); print(tf.sysconfig.get_include()); print(tf.sysconfig.get_lib() + '/libtensorflow_framework.so')"
  ...
  if("${TF_DETECTED_VERSION}" VERSION_LESS "1.4")
  ...
  if(TF_FIND_VERSION_EXACT)
    ...
    set(_TensorFlow_KNOWN_VERSIONS ${TensorFlow_ADDITIONAL_VERSIONS}
        "1.4" "1.4.0" "1.9" "1.9.0" "1.10" "1.10.0" "1.11" "1.11.0")
    set(_TensorFlow_TEST_VERSIONS)
...
macro(add_tensorflow_cpu_operation op_name)
  ...
  add_library(${op_name}_op SHARED ${SOURCE_DIR}/${op_name}_dataset_ops.cc ${SOURCE_DIR}/dataset_ops.cc )
