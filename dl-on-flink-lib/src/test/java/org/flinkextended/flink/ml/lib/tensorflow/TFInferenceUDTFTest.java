...
public class TFInferenceUDTFTest {
    ...
    public void eval() throws Exception {
        ...
        tableEnv.createTemporaryTable(
                "source",
                TableDescriptor.forConnector("TableDebugRow")
                        .schema(
                                Schema.newBuilder()
    ...
    public void eval4() throws Exception {
        String modelDir =
                "file://" + this.getClass().getClassLoader().getResource("").getPath() + "export2";
        ...
        tableEnv.createTemporaryTable(
                "sink", TableDescriptor.forConnector("print").schema(sinkTableSchema).build());
