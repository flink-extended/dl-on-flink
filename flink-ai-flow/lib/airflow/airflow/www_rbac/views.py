...
class TaskInstanceModelView(AirflowModelView):
    ...
    def task_execution_url_formatter(attr):
        task_execution_url = attr.get('task_execution_url')
        return Markup(
            '<a href="{task_execution_url}">'
            '    <span class="glyphicon glyphicon-book" aria-hidden="true">'
            '</span></a>').format(task_execution_url=task_execution_url)
...
class TaskExecutionModelView(AirflowModelView):
    ...
    datamodel = AirflowModelView.CustomSQLAInterface(models.TaskExecution)
