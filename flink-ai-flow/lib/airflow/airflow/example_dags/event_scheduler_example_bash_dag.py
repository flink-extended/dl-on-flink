...
dag = DAG(dag_id='event_scheduler_example_bash_dag', start_date=timezone.utcnow(), schedule_interval="@once")
...
op_4 = BashOperator(task_id='4_job', dag=dag, bash_command='echo "4 hello word!"', env={"a":"a"})
