...
from ai_flow.rest_endpoint.protobuf.metric_service_pb2 import MetricMetaResponse, ListMetricMetasResponse, \
    MetricSummaryResponse, ListMetricSummariesResponse
...
def metric_meta_to_table(metric_name: Text,
    ...
    return SqlMetricMeta(metric_name=metric_name,
...
def metric_summary_to_table(metric_name: Text,
    ...
    return SqlMetricSummary(metric_name=metric_name,
