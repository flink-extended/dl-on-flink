...
from ai_flow.common.result import BaseResult
...
class WorkflowOperationResult(BaseResult):

    def __init__(self, workflow_info: WorkflowInfo, status: Status = Status.OK, error_message: Text = None):
...
class WorkflowExecutionResult(BaseResult):
    def __init__(self,
                 execution_info: Union[WorkflowExecutionInfo, List[WorkflowExecutionInfo]],
                 message: Text = None,
