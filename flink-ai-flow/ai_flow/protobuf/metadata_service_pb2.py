...
_UPDATEWORKFLOWREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='context_extractor_in_bytes', full_name='ai_flow.UpdateWorkflowRequest.context_extractor_in_bytes', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='graph', full_name='ai_flow.UpdateWorkflowRequest.graph', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEWORKFLOWREQUEST.fields_by_name['graph'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
