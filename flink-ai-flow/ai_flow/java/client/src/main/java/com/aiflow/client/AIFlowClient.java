...
public class AIFlowClient {
  ...
  public AIFlowClient(
    ...
    public ExampleMeta registerExample(String name, ExecutionType supportType, String dataFormat, String description,
        ...
        return this.metadataClient.registerExample(name, supportType, dataFormat, description, batchUri, streamUri, createTime, updateTime, properties,
                nameList, typeList);
    }
    ...
    public ExampleMeta registerExampleWithCatalog(String name, ExecutionType supportType, String catalogName, String catalogType,
        ...
        return this.metadataClient.registerExampleWithCatalog(name, supportType, catalogName, catalogType, catalogConnectionUri, catalogVersion, catalogTable, catalogDatabase);
    }
    ...
    public ExampleMeta updateExample(String name, ExecutionType supportType, String dataFormat, String description,
                                     ...
                                     String catalogConnectionUri, String catalogVersion, String catalogTable, String catalogDatabase) throws Exception {
        return this.metadataClient.updateExample(name, supportType, dataFormat, description, batchUri, streamUri, updateTime, properties, nameList, typeList,
                catalogName, catalogType, catalogConnectionUri, catalogVersion, catalogTable, catalogDatabase);
    }
    ...
    public ModelVersionMeta registerModelVersion(String modelPath, String modelMetric, String modelFlavor, String versionDesc, Long modelId, Long workflowExecutionId) throws Exception {
        return this.metadataClient.registerModelVersion(modelPath, modelMetric, modelFlavor, versionDesc, modelId, workflowExecutionId);
    }
    ...
    public WorkflowExecutionMeta registerWorkFlowExecution(String name, State executionState, Long projectId,
        ...
        return this.metadataClient.registerWorkFlowExecution(name, executionState, projectId, properties, startTime, endTime, logUri, workflowJson, signature);
    }
    ...
    public WorkflowExecutionMeta updateWorkFlowExecution(String name, State executionState, Long projectId,
        ...
        return this.metadataClient.updateWorkFlowExecution(name, executionState, projectId, properties, endTime, logUri, workflowJson, signature);
    }
    ...
    public JobMeta registerJob(String name, State jobState, Long workflowExecutionId, Map<String, String> properties,
        ...
        return this.metadataClient.registerJob(name, jobState, workflowExecutionId, properties, jobId, startTime, endTime, logUri, signature);
    }
    ...
    public JobMeta updateJob(String name, State jobState, Long workflowExecutionId, Map<String, String> properties,
        ...
        return this.metadataClient.updateJob(name, jobState, workflowExecutionId, properties, jobId, endTime, logUri, signature);
    }
    ...
    public ArtifactMeta registerArtifact(String name, String dataFormat, String description, String batchUri, String streamUri,
        ...
        return this.metadataClient.registerArtifact(name, dataFormat, description, batchUri, streamUri, createTime, updateTime, properties);
    }
    ...
    public ArtifactMeta updateArtifact(String name, String dataFormat, String description, String batchUri, String streamUri,
        ...
        return this.metadataClient.updateArtifact(name, dataFormat, description, batchUri, streamUri, updateTime, properties);
    }
    ...
    public ModelVersion createModelVersion(String modelName, String modelPath, String modelMetric, String modelFlavor, String versionDesc) throws Exception {
        return this.modelCenterClient.createModelVersion(modelName, modelPath, modelMetric, modelFlavor, versionDesc);
    }
    ...
    public ModelVersion updateModelVersion(String modelName, String modelVersion, String modelPath, String modelMetric, String modelFlavor, String versionDesc, ModelStage currentStage) throws Exception {
        return this.modelCenterClient.updateModelVersion(modelName, modelVersion, modelPath, modelMetric, modelFlavor, versionDesc, currentStage);
    }
     ...
     * @param key          Key of notification for listening.
     */
    public void stopListenNotification(String key) {
